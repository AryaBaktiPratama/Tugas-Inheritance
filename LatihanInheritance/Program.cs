...
namespace LatihanInheritance
{
    class Program
    {
        ...
        {
            Person person = new Person("Arya", 18);
            person.GetNameAndAge();

            Teacher teacher = new Teacher("Pratama", 38, "190345", "Pemrograman");
            teacher.GetNameAndAge();

            Student student = new Student("Arya Bakti Pratama", 18, "19.11.2837", "arya.pratama@students.amikom.ac.id");
